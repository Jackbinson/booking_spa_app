// Thư viện Material cung cấp form, CalendarDatePicker và showTimePicker.
import 'package:flutter/material.dart';
// Provider dùng để gọi BookingProvider khi xác nhận đặt lịch.
import 'package:provider/provider.dart';

// Import màu, style, widget dùng chung, model dịch vụ và provider booking.
...
// Màn hình đặt lịch cho một SpaService đã chọn.
class BookingScreen extends StatefulWidget {
  const BookingScreen({super.key, required this.service});

  // Dịch vụ được truyền từ màn chi tiết để đặt lịch.
...
class _BookingScreenState extends State<BookingScreen> {
  ...
  @override
  // Hủy controller form khi rời màn booking.
  void dispose() {
  ...
  @override
  // build dựng phần giao diện của widget trong luồng đặt lịch.
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            PrimaryButton(
              label: booking.isLoading ? 'Đang xử lý...' : 'Xác nhận đặt lịch',
  ...
  // Validate ngày/giờ/form rồi tạo lịch hẹn qua BookingProvider.
  Future<void> _submit() async {
    ...
    if (!success) {
      _showError(
        provider.errorMessage ?? 'Không thể đặt lịch. Vui lòng thử lại.',
      );
      return;
    }
  ...
  // Hiển thị lỗi nhập liệu hoặc lỗi đặt lịch bằng SnackBar.
...
// Widget chọn ngày, giới hạn từ hôm nay đến 90 ngày sau.
...
// Widget chọn giờ bằng chip gợi ý hoặc hộp thoại đồng hồ.
class _TimeSelector extends StatelessWidget {
  ...
  // Mở showTimePicker và trả giờ đã chọn về callback cha.
  ...
  // Chuyển chuỗi HH:mm thành TimeOfDay để làm giờ mặc định cho picker.
  ...
  // Format TimeOfDay về chuỗi HH:mm để lưu vào lịch hẹn.
...
// Card tóm tắt dịch vụ đang được đặt lịch.
      ...
      child: Row(
        children: [
          ClipRRect(
            ...
            child: _ServiceThumb(service: service),
          ),
...
// Ảnh thumbnail của dịch vụ, có placeholder khi thiếu ảnh hoặc tải lỗi.
class _ServiceThumb extends StatelessWidget {
  ...
  // Placeholder dùng khi dịch vụ không có ảnh hợp lệ.
  Widget _placeholder() {
    return Container(
      width: 82,
      height: 82,
...
// Khối tổng kết thông tin đặt lịch trước khi xác nhận.
...
// Một dòng label/value trong phần tổng kết booking.
